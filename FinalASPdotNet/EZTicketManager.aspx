...
<body>
    ...
    <div>
        <asp:Panel ID="Panel1" runat="server" GroupingText="EZTicket Manager"  >
            <br />
            <table><tr>
                <td> <asp:Button ID="btuViewAll" runat="server" Text="View All Submitted Tickets" OnClick="btuViewAll_Click" /></td>
                
                <td>
                    <asp:DropDownList ID="DropDownList1" runat="server" Height="22px" Width="212px"  DataTextField="Status" DataValueField="Status" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"   ></asp:DropDownList></td>
                <td>
                    <asp:DropDownList ID="DropDownList2" runat="server" Height="20px" Width="231px" AutoPostBack="True" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged"></asp:DropDownList></td>
                   
            <td>
                <asp:DropDownList ID="DropDownList3" runat="server" Height="20px" Width="231px" AutoPostBack="True" OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged"></asp:DropDownList></td>
            </tr>
            </table>
            <br />
            <br />
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="TicketNumber" AutoGenerateEditButton="True" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" >
                <Columns>
                   ...
                   <%-- <asp:BoundField DataField="AssignedToEm.FirstName" HeaderText="FirstName" SortExpression="AssignedToEm" ReadOnly="true"/>--%>
                    <%--<asp:BoundField DataField="AssignedToEm.LastName" HeaderText="LastName" SortExpression="AssignedToEm" ReadOnly="true"/>--%>
